...
models_out = [Reshape((num_locs, 1))(model([t_input, x_input])) for model in models] + out_momentum
...
for d in xrange(1, 32):
    ...
    for t in xrange(96 - T):
        ...
        momentum_predictor.fit(xX, Y1, batch_size=batch_size, epochs=20, shuffle=True, verbose=1, callbacks=[EarlyStopping(monitor='loss', patience=0, verbose=1, mode='auto')])
